...
public class OfferItem {
    ...
    public OfferItem(String productId, BigDecimal productPrice, String productName, Date productSnapshotDate,
        ...
        this.product = new Product(productId, productName, productType, productSnapshotDate, productPrice);
        ...
        this.totalPrice.setAmount(product.getPrice().getAmount().multiply(new BigDecimal(quantity)).subtract(discountValue));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + (product.getSnapshotDate() == null ? 0 : product.getSnapshotDate().hashCode());
